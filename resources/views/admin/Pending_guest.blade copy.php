...
<!-- <script>
            ...
            .then(response => {
                ...
                guests.forEach((guest, index) => {
                    ...
                    const accessoriesButton =
                        `<button class="btn btn-info btn-sm" onclick='viewAccessories(${JSON.stringify(guest.accessory_heads || [])})'>View</button>`;
    ...
    //         const name = item.name || 'N/A'; // AccessoryHead name directly
    //         const pivot = item.pivot || {};
    //         const price = pivot.price ?? 'N/A';
    //         const fromDate = pivot.from_date ?? 'N/A';
    //         const toDate = pivot.to_date ?? 'N/A';

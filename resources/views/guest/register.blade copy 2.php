            ...
            <div class="card-body">
                ...
                {{-- <div class="row mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="remarks" id="remarks" rows="3" class="form-control" aria-describedby="remarksError"></textarea>
                        <div id="remarksError" class="invalid-feedback"></div>
                    </div>
                </div> --}}
                {{-- <div class="card p-4 shadow-sm mb-4">
                    <h5 class="mb-3">Fee Waiver Details</h5>

                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" name="fee_waiver" id="fee_waiver"
                            value="1">
                        <label class="form-check-label fw-semibold" for="fee_waiver">
                    ...
                    <div class="mb-3">
                        <label for="waiver_document" class="form-label">Upload Supporting Document</label>
                        <input type="file" name="attachment" id="waiver_document" class="form-control"
                            accept=".pdf,.jpg,.png">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="remarks" id="remarks" rows="3" class="form-control"
                            placeholder="Add any additional notes or comments..." aria-describedby="remarksError"></textarea>
                        <div id="remarksError" class="invalid-feedback"></div>
                    </div>
                </div> --}}

                {{-- <div class="card border-0 shadow-sm p-4 mb-4">
                    <h5 class="mb-3 text-primary">Fee Waiver Application</h5>
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label class="form-check-label fw-medium" for="fee_waiver">
                            I have an eligible resource and wish to apply for a fee waiver
                        </label>
                        <div id="feeWaiverError" class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="remarks" id="remarks" rows="3" class="form-control"
                            placeholder="Add any relevant notes or context for your application..." aria-describedby="remarksError"></textarea>
                        <div id="remarksError" class="invalid-feedback"></div>
                    </div>
                </div> --}}
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="emergency_no" id="emergency_no" class="form-control"
                            pattern="[0-9]{10}" aria-describedby="emergencyNoError" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="parent_no" id="parent_no" class="form-control" pattern="[0-9]{10}"
                            aria-describedby="parentNoError">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="guardian_no" id="guardian_no" class="form-control"
                            pattern="[0-9]{10}" aria-describedby="guardianNoError">

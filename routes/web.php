...
Route::view('/admin/residents', 'admin.residents')->name('admin.residents');
    Route::view('/admin/guest/forms', 'admin.guest_forms')->name('admin.guest_forms');
    Route::view('/admin/form_verify/{id}', 'admin.form_verify')->name('admin.form_verify');
...
Route::get('adm', [TestController::class, 'adm'])->name('adm');
Route::get('adm/store', [TestController::class, 'store'])->name('adm.store');
// Route::get('/departments/{faculty}', [TestController::class, 'getByFaculty']);
// Route::get('/courses/{department}', [TestController::class, 'getByDepartment']);

Route::get('/departments/{faculty}', [TestController::class, 'getByFaculty']);
Route::get('/courses/department/{department}', [TestController::class, 'getByDepartment']);
Route::get('/courses/faculty/{faculty}', [TestController::class, 'getByFaculty']);
